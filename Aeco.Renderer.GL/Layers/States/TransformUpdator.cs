...
public class TransformUpdator : VirtualLayer, IGLUpdateLayer, IGLLateUpdateLayer
{
    ...
    private unsafe ref Transform GetTransform(IDataLayer<IComponent> context, Guid id)
    {
    ...
    private unsafe void TagDirty(IDataLayer<IComponent> context, Guid id, HashSet<Guid> dirtyIds)
    {
        dirtyIds.Add(id);
    ...
    private unsafe void TagChildrenDirty(IDataLayer<IComponent> context, in Children children, HashSet<Guid> dirtyIds)
    {
    ...
    private unsafe void AddChild(IDataLayer<IComponent> context, Guid parentId, Guid childId)
    {
        ref var children = ref context.Acquire<Children>(parentId);
        children.Ids = children.Ids.Add(childId);
    ...
    private unsafe bool RemoveChild(IDataLayer<IComponent> context, Guid parentId, Guid childId)
    {
        ...
        ref var children = ref context.Acquire<Children>(parentId);
        children.Ids = children.Ids.Remove(childId);
