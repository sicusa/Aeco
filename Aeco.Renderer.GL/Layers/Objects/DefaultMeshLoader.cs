...
public class DefaultMeshLoader : VirtualLayer, IGLLoadLayer
{
    public void OnLoad(IDataLayer<IComponent> context)
    {
        ref var quad = ref context.Acquire<Mesh>(Polygons.Quad);
        ...
        quad.Indeces = new uint[] {
            0, 1, 3,   // first triangle
            1, 2, 3    // second triangle
        };

        ref var cube = ref context.Acquire<Mesh>(Polygons.Cube);
        ...
        Console.WriteLine("Default meshes loaded.");
    }
}