...
public class ShaderProgramManager : ResourceManagerBase<ShaderProgram, ShaderProgramData, ShaderProgramResource>
{
    private static readonly Dictionary<string, string> s_internalShaderFiles = new() {
        ["aeco/common.glsl"] = InternalAssets.LoadText("Shaders.aeco.common.glsl"),
        ["aeco/variant.glsl"] = InternalAssets.LoadText("Shaders.aeco.variant.glsl"),
        ["aeco/instancing.glsl"] = InternalAssets.LoadText("Shaders.aeco.instancing.glsl"),
        ["aeco/transparency.glsl"] = InternalAssets.LoadText("Shaders.aeco.transparency.glsl"),
        ["aeco/lighting.glsl"] = InternalAssets.LoadText("Shaders.aeco.lighting.glsl"),
