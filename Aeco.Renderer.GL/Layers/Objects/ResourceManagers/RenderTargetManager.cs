...
public class RenderTargetManager : ResourceManagerBase<RenderTarget, RenderTargetData, RenderTargetResource>, IGLResizeLayer
{
    ...
    protected override void Initialize(
        IDataLayer<IComponent> context, Guid id, ref RenderTarget framebuffer, ref RenderTargetData data, bool updating)
    {
    ...
    private void UpdateData(
        IDataLayer<IComponent> context, Guid id, ref RenderTarget framebuffer, ref RenderTargetData data, int width, int height)
    {
        data.Width = width;
        data.Height = height;
    ...
    protected override void Uninitialize(IDataLayer<IComponent> context, Guid id, in RenderTarget framebuffer, in RenderTargetData data)
    {
        DeleteTextures(in data);
